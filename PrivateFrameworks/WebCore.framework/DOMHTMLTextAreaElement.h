...
// DOMHTMLTextAreaElement (AutocapitalizeAdditions)

- (int)_autocapitalizeType;

// DOMHTMLTextAreaElement (DOMUIKitComplexityExtensions)
...
// DOMHTMLTextAreaElement (UITextInputAdditions)
...
// DOMHTMLTextAreaElement (UIWebBrowserViewPrivate)
...
// DOMHTMLTextAreaElement (UIWebInteraction)
