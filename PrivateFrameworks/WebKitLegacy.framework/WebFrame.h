...
// WebFrame (BrowserAdditions)

- (BOOL)isMainFrame;

// WebFrame (UIWebDocumentViewTextSelecting)

- (BOOL)isTexty;

// WebFrame (UIWebSelectionAdditions)
