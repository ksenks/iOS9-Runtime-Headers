...
// UIScrollView (StateRestoration)

- (BOOL)_viewIsInsideNavigationController;
- (void)decodeRestorableStateWithCoder:(id)arg1;
- (void)encodeRestorableStateWithCoder:(id)arg1;

// UIScrollView (UIAutoscrollAdditions)

- (BOOL)_isScrollingEnabled;

// UIScrollView (UIKitAccessibilityInterfaceBuilderSupport)
...
// UIScrollView (UIWebSelectionAutoscroll)

- (float)maxVelocityInDirection:(int)arg1;
- (int)scrollableDirections;

// UIScrollView (_UIOldConstraintBasedLayoutSupport)
