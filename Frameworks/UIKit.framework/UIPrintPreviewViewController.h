...
@property struct _NSRange { unsigned int x1; unsigned int x2; } validRenderRange;
...
- (void)setValidRenderRange:(struct _NSRange { unsigned int x1; unsigned int x2; })arg1;
- (void)trackCenterCell;
- (void)updateLayout;
- (void)updatePageNumberBadgeLocation;
- (void)updateValidRenderRange;
