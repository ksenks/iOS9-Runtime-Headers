...
@interface UIWindow : UIView <NSISEngineDelegate, UIGestureRecognizerDelegatePrivate> {
...
- (void)_playPauseLongPressRecognizerAction:(id)arg1;
...
// UIWindow (HostedWindowHostingHandle)
...
// UIWindow (UIKitAccessibilityInterfaceBuilderSupport)
