...
// UIDocumentInteractionController (ArchiveSupport)
...
// UIDocumentInteractionController (QLPreviewController)
...
// UIDocumentInteractionController (QLPreviewControllerDataSource)

- (int)numberOfPreviewItemsInPreviewController:(id)arg1;
- (id)previewController:(id)arg1 previewItemAtIndex:(int)arg2;

// UIDocumentInteractionController (UIPopoverControllerDelegate)
