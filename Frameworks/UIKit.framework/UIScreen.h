...
@interface UIScreen : NSObject <UICoordinateSpace, UIFocusContainer, UIFocusEnvironment, UITraitEnvironment, _UITraitEnvironmentInternal> {
...
- (BOOL)_isCarScreen;
- (BOOL)_isEnvironmentEligibleForFocusUpdate:(id)arg1;
- (BOOL)_isExternal;
- (BOOL)_isMainScreen;
- (BOOL)_isOverscanned;
...
- (void)_noteEnvironmentNeedsFocusUpdate:(id)arg1;
...
- (void)_updateFocusToView:(id)arg1;
- (void)_updateFocusWithContext:(id)arg1 animationCoordinator:(id)arg2;
- (void)_updateOverscanCompensationAllowingBackgroundUpdate:(BOOL)arg1;
- (void)_updateReferenceBoundsToSceneReferenceBounds:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1 fromInterfaceOrientation:(int)arg2;
- (void)_updateTraits;
- (void)_updateUserInterfaceIdiom;
- (void)_updateWithMainSceneSettings:(id)arg1;
- (int)_userInterfaceIdiom;
