...
- (void)_configureSizeViewConstraintsForWindow:(id)arg1;
...
// _UIRemoteViewController (Protected)
...
// _UIRemoteViewController (_UIRemoteViewController_AutomaticInvaldiation)
