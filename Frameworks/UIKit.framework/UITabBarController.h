...
@interface UITabBarController : UIViewController <NSCoding, UIGestureRecognizerDelegate, UITabBarDelegate> {
...
// UITabBarController (ActivityContinuationPrivate)

- (id)_additionalViewControllersToCheckForUserActivity;

// UITabBarController (StateRestoration)
