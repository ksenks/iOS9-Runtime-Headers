...
// UIWebDocumentView (InteractionPrivate)
...
// UIWebDocumentView (SyntheticEvents)

- (id)_scriptingInfoForForm:(id)arg1;
- (id)_scriptingInfoForLink:(id)arg1;
- (id)scriptingInfoWithChildren;

// UIWebDocumentView (UIWebDocumentViewPrintFormatter)

- (Class)_printFormatterClass;

// UIWebDocumentView (UIWebDocumentViewTextSelecting)
...
// UIWebDocumentView (WebUIDocumentView)
