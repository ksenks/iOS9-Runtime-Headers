...
- (void)asyncIfPossibleWriteToDisk;
- (void)asyncIfPossibleWriteToDiskAndFlushCache;
...
- (void)clearCache;
- (void)consumeTemporaryFileToWriteToByCleaningDirtyStateWithBlock:(id /* block */)arg1;
